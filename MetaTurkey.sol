...
contract MetaTurkey is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**7 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Meta Turkey";
    string private _symbol = "METATURKEY";
    ...
    uint256 public _taxFee = 3; //consists of reflect tax
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 7; //consists of buyback + liq + dividends tax 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    
    uint256 public div1 = 28;
    ...
    uint256 public _maxWallet = 1 * 10**7 * 10**5;
    uint256 public _maxTxAmount = 3 * 10**6 * 10**5;
    uint256 private minimumTokensBeforeSwap = 1 * 10**5 * 10**5; 
    ...
    address payable public buybackAddress = payable(0xa5b55607d183087FD50A44b2fccAe261347cFD6C);
    address payable public lpAddress = payable(0xa5b55607d183087FD50A44b2fccAe261347cFD6C);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        transferToAddressETH(buybackAddress, transferredBalance);
    ...
    function addressChange(address payable _lpAddress, address payable _buybackAddress) external onlyOwner{
    ...
    function removeSniper(address account, bool state) external onlyOwner { 
        _isSniper[account] = state;
    }
    ...
    function buyBack() public payable {
        ...
        path[1] = address(this);
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value : msg.value}(0,path,buybackAddress,block.timestamp.add(10));
    }
